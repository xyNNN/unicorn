...
class WeightConverter extends AbstractMathematicalConverter
{

    /**
     * @var Unit $kilogram Static instance for conversions
     */
    ...
    {
        $this->units[] = self::$kilogram = new Unit('kilogram ', 'kg', '1');
    }

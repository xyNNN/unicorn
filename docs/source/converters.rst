...
This section will provide you general information on how to use converters, how to add your own units and how to use
the ConvertibleValue, which is unicorns general data transfer object.
...
.. toctree::
   ...
   converter-registry
   abstract-mathematical-converter
   length-converter
   currency-converter
